...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2 rounded-[8px] px-2.5 py-1.5 font-mono text-[12px] outline-none transition-colors",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    checked={checked}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-[8px] py-1.5 pl-8 pr-2 font-mono text-[12px] outline-none focus:bg-white/[0.06]",
      className,
    )}
    {...props}
  >
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-[8px] px-2.5 py-1.5 font-mono text-[12px] outline-none focus:bg-white/[0.06]",
      inset && "pl-8",
      className,
    )}
    {...props}
