...
const contentClass =
  "z-50 min-w-[10rem] overflow-hidden rounded-[12px] border border-[color:var(--hairline)] bg-[color:var(--surface-2)] p-1 text-foreground shadow-[0_24px_48px_rgba(0,0,0,.65),var(--rim-light-shadow)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0";
const itemClass =
