    ...
    <div className="rounded-[18px] border border-[color:var(--hairline)] bg-[color:var(--surface-0)] p-5">
      <div className="mb-5 flex items-end justify-between">
        <div>
          ...
          <h3 className="mt-1 font-mono text-xl font-bold text-foreground">Runtime overview</h3>
        </div>
        <LatencyIndicator value={84} />
      </div>
      <div className="grid gap-4 lg:grid-cols-[1fr_1.25fr]">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <SparklineMetric
            ...
            accent="var(--neon-red)"
          />
          <div className="flex items-center justify-center rounded-[14px] border border-[color:var(--hairline)] bg-[color:var(--surface-1)] p-4">
        ...
        <TelemetryPanel>
          ...
          <TelemetryRow label="Throughput" value="8.4 GB/s" tone="cyan" />
          <TelemetryRow label="Connections" value="2,482" tone="green" />
          <TelemetryRow label="Cache hit" value="96.8%" tone="purple" />
          <TelemetryRow label="Queue depth" value="184" tone="yellow" />
        </TelemetryPanel>
      </div>
    </div>
  );
