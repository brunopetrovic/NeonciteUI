...
const commonReplacements = [
  ["shadow-[0_50px_100px_rgba(0,0,0,0.9),var(--rim-light-shadow)]", "shadow-[var(--shadow-dialog)]"],
  ["shadow-[0_50px_100px_rgba(0,0,0,1),inset_0_1px_1px_rgba(255,255,255,0.08)]", "shadow-[var(--shadow-dialog)]"],
  ["shadow-[0_-24px_64px_rgba(0,0,0,.75),var(--rim-light-shadow)]", "shadow-[var(--shadow-drawer)]"],
  ["shadow-[0_24px_48px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.04)]", "shadow-[var(--shadow-floating)]"],
  ["shadow-[0_24px_48px_rgba(0,0,0,.65),var(--rim-light-shadow)]", "shadow-[var(--shadow-floating)]"],
  ["shadow-[0_24px_48px_rgba(0,0,0,0.6)]", "shadow-[var(--shadow-floating)]"],
  ["shadow-[0_8px_32px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]", "shadow-[var(--machined-shadow)]"],
  ["shadow-[0_8px_24px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.05)]", "shadow-[var(--machined-shadow)]"],
  ["shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_4px_12px_rgba(0,0,0,0.5)]", "shadow-[var(--shadow-avatar)]"],
  ...
  ["shadow-[inset_0_1px_2px_rgba(0,0,0,0.4),0_0_16px_rgba(255,42,157,0.5)]", "shadow-[var(--shadow-switch-checked)]"],
  ["shadow-[0_4px_8px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.5)]", "shadow-[var(--shadow-control-thumb)]"],
  ["shadow-[0_2px_4px_rgba(0,0,0,0.6),inset_0_1px_1px_rgba(255,255,255,0.5)]", "shadow-[var(--shadow-control-thumb)]"],
  ["shadow-[0_2px_0_rgba(0,0,0,.65),inset_0_1px_1px_rgba(255,255,255,.08)]", "shadow-[var(--shadow-keycap)]"],
  ["shadow-[inset_0_8px_24px_rgba(0,0,0,.7),var(--rim-light-shadow)]", "shadow-[var(--recessed-shadow)]"],
...
for (const root of SOURCE_ROOTS) {
  for (const file of walk(path.join(ROOT, root))) {
    ...
    after = after
      .replaceAll("[&_.recharts-cartesian-grid_line[stroke='var(--neon-cyan)']]", "[&_.recharts-cartesian-grid_line]")
      .replaceAll("[&_.recharts-cartesian-grid_line[stroke='#ccc']]", "[&_.recharts-cartesian-grid_line]")
      ...
      .replaceAll("[&_.recharts-reference-line_[stroke='#ccc']]", "[&_.recharts-reference-line_line]")
    ...
    after = after
      .replaceAll("data-[state=checked]:text-white", "data-[state=checked]:text-[color:var(--surface-0)]")
      .replaceAll("aria-selected:text-white ", "aria-selected:text-[color:var(--surface-0)] ")
      .replaceAll("data-[state=active]:text-white", "data-[state=active]:text-[color:var(--surface-0)]")
...
const shadowAnchor = "  --shadow-inset-hairline: inset 0 1px 0 color-mix(in oklab, white 5%, transparent);\n";
