...
const BLOCKS = z.array(BlockSchema).parse(JSON.parse(fs.readFileSync(BLOCKS_PATH, "utf8")));
const THEMES = z.array(ThemeSchema).parse(JSON.parse(fs.readFileSync(THEMES_PATH, "utf8")));
